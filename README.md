...
GitHub Pages branch for personal Codex web apps.

## Apps

| App | Folder | Live URL |
| --- | --- | --- |
| Portfolio Command Center | `portfolio-command-center-live/` | `https://biscocho-droid.github.io/codex-apps/portfolio-command-center-live/` |
| Monthly Budget | `monthly-budget/` | `https://biscocho-droid.github.io/codex-apps/monthly-budget/` |
| S&P 500 Value Finder | `sp500-value-finder/` | `https://biscocho-droid.github.io/codex-apps/sp500-value-finder/` |
...
| Aurora Market Terminal | `market-terminal/` | `https://biscocho-droid.github.io/codex-apps/market-terminal/` |

The root URL is an app launcher:

```text
https://biscocho-droid.github.io/codex-apps/
```
